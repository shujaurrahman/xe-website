  ...
  <div class="wrap">
    <div class="bdh-head bdh-head--row">
      <div>
        ...
        <h2 class="h2" id="standards-t"><span class="g">Built to the frameworks</span> your reviewers will ask about.</h2>
      </div>
      <div><p class="lead">These shape the evaluation plan, the guardrails and the records we hand over. We build to them and align with them; they are not certifications we claim to hold.</p></div>
    </div>
