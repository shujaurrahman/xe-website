  ...
  <div class="wrap">
    <div class="bdh-head bdh-head--row" data-rv>
      <div><p class="lbl lbl--blue"><span class="dot"></span>Where it sits in the engine</p>
        <h2 class="h2" id="how-t"><span class="g">Five steps,</span> every time it runs.</h2></div>
      <div><p class="lead"><?= $MTD_CRS ? 'The five practices in the order a customer meets them. Each one hands the next a sharper definition of who the customer is and what they need.' : 'The path a single decision takes through ' . e(strtolower($CAP['short'])) . ', from the signal that starts it to the measure that proves it. The highlighted step is where this capability does its own work.' ?></p></div>
    </div>
