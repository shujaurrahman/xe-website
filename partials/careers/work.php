...
$car_norms = [
  ['users', 'Hybrid by team', 'Teams agree their studio days together. Client workshops are in person when it helps.'],
  ...
  <div class="wrap">
    <div class="bdh-head bdh-head--row" data-rv>
      <div><p class="lbl lbl--blue"><span class="dot"></span>How and where we work</p>
        <h2 class="h2" id="work-t"><span class="g">Two studios,</span> and the rest of India.</h2></div>
      <div><p class="lead">Work from our studios in New Delhi or Ludhiana, or remotely from anywhere in India for roles marked remote.</p></div>
    </div>
    <div class="car-work__places">
      ...
      <article class="car-place car-place--remote">
        ...
        <p class="car-place__a">For roles marked Remote (India). Occasional travel to a studio or client for workshops and team weeks.</p>
      </article>
    </div>
