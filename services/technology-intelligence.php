...
$page = [
    ...
    'desc'  => 'We build and run the technical foundation a brand needs — software, AI systems, infrastructure, and the security and support to keep it all dependable.',
];

/* Pulled from data/site.php so the page, the menu and the footer can never
   disagree about what this discipline offers. */
$d = null;
foreach ($SITE['disciplines'] as $x) { if ($x['slug'] === 'technology-intelligence') $d = $x; }
