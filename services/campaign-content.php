...
$page = [
    ...
    'desc'  => 'We build campaigns and content systems that earn a place in culture — using storytelling that pulls technology, media, and design into one thread.',
];

/* Pulled from data/site.php so the page, the menu and the footer can never
   disagree about what this discipline offers. */
$d = null;
foreach ($SITE['disciplines'] as $x) { if ($x['slug'] === 'campaign-content') $d = $x; }
