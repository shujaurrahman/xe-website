...
$page = [
    ...
    'desc'  => 'We build the technology backbone that makes personalization, automation, and always-on marketing possible, and design the relationships that turn a single purchase into a lasting one.',
];

/* Pulled from data/site.php so the page, the menu and the footer can never
   disagree about what this discipline offers. */
$d = null;
foreach ($SITE['disciplines'] as $x) { if ($x['slug'] === 'marketing-technology') $d = $x; }
