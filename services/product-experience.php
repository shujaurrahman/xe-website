...
$page = [
    ...
    'desc'  => 'We rethink how people actually use what a brand builds — shaping the strategy and design that sits ahead of every build.',
];

/* Pulled from data/site.php so the page, the menu and the footer can never
   disagree about what this discipline offers. */
$d = null;
foreach ($SITE['disciplines'] as $x) { if ($x['slug'] === 'product-experience') $d = $x; }
