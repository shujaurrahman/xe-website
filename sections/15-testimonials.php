...
<section class="band band--rules s15" id="testimonials" aria-labelledby="s15-t">
  <div class="wrap s15__grid">
    ...
    <!--
      ...
      quoted, attribution is role and sector only, and the portraits are STOCK imagery from the
      reference sites — not these clients. Replace the quotes and the photographs before launch.
    -->
    <div class="s15__list" data-acc>
      ...
      <div class="s15__row">
        <button class="s15__btn" type="button" id="s15-b0" data-acc-b aria-expanded="true" aria-controls="s15-a0">
          ...
          <span class="s15__who">
            ...
            <span class="s15__role">Consumer health · nine markets</span>
          </span>
          <span class="s15__mark" aria-hidden="true">›</span>
        </button>
        <div class="s15__panel" id="s15-a0" data-acc-p>
          <p class="s15__q">They rebuilt the brand as a system, then handed us the keys to it. Six
            months on, our own team ships a market launch without calling anyone.</p>
        </div>
      </div>
      ...
      <div class="s15__row">
        <button class="s15__btn" type="button" id="s15-b1" data-acc-b aria-expanded="false" aria-controls="s15-a1">
          ...
          <span class="s15__who">
            ...
            <span class="s15__role">Financial services</span>
          </span>
          <span class="s15__mark" aria-hidden="true">›</span>
        </button>
        <div class="s15__panel" id="s15-a1" data-acc-p>
          <p class="s15__q">The audit was uncomfortable and completely correct. They fixed the three
            things that mattered before touching anything cosmetic.</p>
        </div>
      </div>
      ...
      <div class="s15__row">
        <button class="s15__btn" type="button" id="s15-b2" data-acc-b aria-expanded="false" aria-controls="s15-a2">
          ...
          <span class="s15__who">
            <b>VP Product</b>
            <span class="s15__role">B2B software</span>
          </span>
          <span class="s15__mark" aria-hidden="true">›</span>
        </button>
        <div class="s15__panel" id="s15-a2" data-acc-p>
          <p class="s15__q">We asked for an assistant and got a straight answer about what not to
            build first. That saved us a quarter.</p>
        </div>
      </div>
      ...
      <div class="s15__row">
        <button class="s15__btn" type="button" id="s15-b3" data-acc-b aria-expanded="false" aria-controls="s15-a3">
          ...
          <span class="s15__who">
            <b>Head of Growth</b>
            <span class="s15__role">Retail &amp; commerce</span>
          </span>
          <span class="s15__mark" aria-hidden="true">›</span>
        </button>
        <div class="s15__panel" id="s15-a3" data-acc-p>
          <p class="s15__q">One team for brand, media and the data underneath it. The weekly review
            is the most useful hour in our calendar.</p>
        </div>
      </div>
      ...
      <div class="s15__row">
        <button class="s15__btn" type="button" id="s15-b4" data-acc-b aria-expanded="false" aria-controls="s15-a4">
          ...
          <span class="s15__who">
            ...
            <span class="s15__role">Hospitality group</span>
          </span>
          <span class="s15__mark" aria-hidden="true">›</span>
        </button>
        <div class="s15__panel" id="s15-a4" data-acc-p>
          <p class="s15__q">They treated direct booking as a product problem rather than a discount
            problem. Nobody else framed it that way.</p>
        </div>
      </div>
      ...
      <div class="s15__row">
        <button class="s15__btn" type="button" id="s15-b5" data-acc-b aria-expanded="false" aria-controls="s15-a5">
          ...
          <span class="s15__who">
            <b>Group CTO</b>
            <span class="s15__role">Telecom &amp; media</span>
          </span>
          <span class="s15__mark" aria-hidden="true">›</span>
        </button>
        <div class="s15__panel" id="s15-a5" data-acc-p>
          <p class="s15__q">Everything they built is in our repositories, under our licences, with
            our people trained on it. That was the whole point.</p>
        </div>
      </div>
