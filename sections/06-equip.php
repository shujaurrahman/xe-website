<section class="band band--rules s06" id="equip" aria-labelledby="s06-t">
  <div class="wrap">
    <div class="s06__head" data-rv>
      <div class="head head--c s06__headin">
        <p class="lbl lbl--blue"><span class="dot"></span>Capabilities</p>
        <h2 class="h2" id="s06-t"><span class="g">Equip your team</span><br>to move faster</h2>
        <p class="lead">Manage brand, product and growth on one system of shared intelligence.</p>
      </div>
      <div class="s06__nav">
        <button class="s06__arrow" type="button" data-s06-prev aria-label="Previous card">
        ...
        <button class="s06__arrow" type="button" data-s06-next aria-label="Next card">
  ...
  <div class="s06__railwrap">
    <div class="s06__rail mq-hold" role="group" aria-roledescription="carousel" aria-label="What we equip teams with">
      <div class="s06__track mq mq--l" data-mq data-s06-track style="--mq-dur:52s">

      <article class="s06__card">
        <p class="pill s06__pill">Agents</p>
        <div class="s06__mock">
      ...
      <article class="s06__card">
        ...
        <h3 class="h3 s06__t">Search &amp; AI Visibility</h3>
        <p class="s06__p">Ranking on Google and getting cited by the answer engines — as one system.</p>
      </article>

      <article class="s06__card">
        <p class="pill s06__pill">Audits</p>
        <div class="s06__mock s06__mock--ring">
      ...
      <article class="s06__card">
        ...
        <h3 class="h3 s06__t">Tech Workforce</h3>
